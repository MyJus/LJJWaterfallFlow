...
@interface LJJWaterfallView()<UICollectionViewDelegate,UICollectionViewDataSource>

@property(nonatomic,readwrite,strong) UICollectionView *collectionView;
@property(nonatomic,strong)LJJWaterfallLayout *layout;

@end

@implementation LJJWaterfallView
...
- (LJJWaterfallLayout *)layout{
    if (_layout == nil) {
        _layout = [[LJJWaterfallLayout alloc] init];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    UICollectionViewCell<LJJWaterfallCellProtocol> *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
    id data = nil;
...
@interface LJJWaterfallLayout()

//不需要放到.h文件中，因为这几个时私有属性
...
@implementation LJJWaterfallLayout
